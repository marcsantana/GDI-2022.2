...
SELECT CPF_USUARIO FROM COMPARECER WHERE ID_EVENTO = ALL(SELECT c.ID_EVENTO FROM COMPARECER c JOIN EVENTO e ON c.ID_EVENTO = e.ID_EVENTO WHERE DATA_INICIO < '01-Jan-1980');
